  ...
  return (
    <section className="mt-10 space-y-6">
      <div className="max-w-xl space-y-3">
        <p className="text-xs uppercase tracking-[0.3em] text-[rgba(0,0,0,0.45)]">
          OFFER YOUR REQUEST
        </p>
        <h1 className="text-4xl font-light leading-tight text-[rgba(0,0,0,0.9)] sm:text-5xl">
          Offload your prayer to a machine.
        </h1>
        <p className="max-w-lg text-sm leading-relaxed text-[rgba(0,0,0,0.7)]">
      ...
      <p className="max-w-md text-xs leading-relaxed text-[rgba(0,0,0,0.6)]">
